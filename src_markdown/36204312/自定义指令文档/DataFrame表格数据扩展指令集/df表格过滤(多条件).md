# 一.功能描述
<font style="color:rgb(51, 51, 51);">对获取到的DataFrame数据集进行多条件过滤操作，并将过滤后的数据返回。</font>

![](https://cdn.nlark.com/yuque/0/2023/jpeg/1675452/1693205265628-91c58c51-960a-4aa2-be31-96f61b752f58.jpeg)

_<font style="color:rgb(102, 102, 102);">注：  
</font>__<font style="color:rgb(102, 102, 102);">1.过滤处理的对象类型为DataFrame，支持多个条件过滤；  
...
![](https://cdn.nlark.com/yuque/0/2023/jpeg/1675452/1693205280183-c0cc2440-394d-4ed4-baa9-90b15bed729f.jpeg)
...
**<font style="color:rgb(51, 51, 51);">条件关系：</font>**<font style="color:rgb(51, 51, 51);">设置筛选条件之间的逻辑关系，它有and和or两个按钮：</font>

<font style="color:rgb(51, 51, 51);">and为逻辑与，也就是所有条件都符合才匹配；</font>

![](https://cdn.nlark.com/yuque/0/2023/jpeg/1675452/1693205318687-af8bdf04-7ce0-468e-a46f-bc14302f2e6b.jpeg)

**<font style="color:rgb(51, 51, 51);">  
</font>**<font style="color:rgb(51, 51, 51);">or为逻辑或，所有条件中只要有一条匹配就满足。</font>

![](https://cdn.nlark.com/yuque/0/2023/jpeg/1675452/1693205298679-233cba10-a088-4c16-8e1c-9e31a66e94bf.jpeg)



**<font style="color:rgb(51, 51, 51);">筛选参数列：</font>**<font style="color:rgb(51, 51, 51);">默认参数方式为二维list类型，筛选参数列相当于将df过滤单条件中的三个参数放入了list</font>**<font style="color:rgb(51, 51, 51);"> [筛选字段，筛选方式，筛选值]。多个条件多个list。</font>**

**<font style="color:rgb(51, 51, 51);">例如：</font>**<font style="color:rgb(51, 51, 51);">[["产品代码", "==", "zs001",],["产品风险等级", ">", 2,],["视频保存时长", "<", 10,]]</font>

**<font style="color:rgb(51, 51, 51);">注：</font>**<font style="color:rgb(51, 51, 51);">筛选字段和筛选值类型根据实际df表格中的类型来填，不一定都是str类型，也会是int类型。</font>

**<font style="color:rgb(51, 51, 51);">即相当于把表格过滤单条件中  [筛选字段，筛选方式，筛选值]，写入一个list。并且将多个筛选的list 放入一个外围大list。</font>**



**<font style="color:rgb(51, 51, 51);">筛选字段：</font>**<font style="color:rgb(51, 51, 51);">输入指定列的字段名称；</font>

**<font style="color:rgb(51, 51, 51);">筛选方式：</font>**<font style="color:rgb(51, 51, 51);">筛选方法，参考下列筛选方法。</font>

**<font style="color:rgb(51, 51, 51);">筛选值：</font>**<font style="color:rgb(51, 51, 51);">输入匹配条件的内容。</font>

<font style="color:rgb(51, 51, 51);"></font>

**<font style="color:rgb(51, 51, 51);">下面依次介绍这些筛选方法：</font>**  
...
**<font style="color:rgb(51, 51, 51);">返回值：</font>**<font style="color:rgb(51, 51, 51);"> 返回表格多条件过滤后得到的数据，其类型依旧为Dataframe。</font>
